...
$isEdit = !empty($item);
?>
<form method="post" action="<?= e(url($isEdit ? 'funcionarios/update' : 'funcionarios/store')) ?>">
    <?= Csrf::field() ?>
    <?php if ($isEdit): ?>
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input type="text" id="cargo" name="cargo" required maxlength="120"
                   value="<?= e(field_value('cargo', $item)) ?>">
        </div>
        <div class="form-group">
    ...
    <div class="form-actions">
        ...
        <a class="btn btn-secondary" href="<?= e(url('funcionarios/list')) ?>">Cancelar</a>
    </div>
</form>
